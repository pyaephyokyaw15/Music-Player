...
youtube = wrapper.querySelector('a');
...
menuIcon = document.querySelector('#menus');
...
sec= document.querySelector('.second input');
...
okButton.addEventListener("click", ()=>{
  ...
  totalSeconds = hour.value*3600 + min.value*60 + sec.value;
  totalMilliSeconds = totalSeconds*1000;
  console.log('Timercount');
  console.log(totalSeconds);
  setTimeout(pauseMusic, totalMilliSeconds);
...
for (let i = 0; i < allMusic.length; i++) {
  ...
  //console.log(liAudioDuartionTag);
